...
namespace AmdarisProject.Presentation.Controllers
{
    ...
    public class ATestController(IMediator mediator, AmdarisProjectDBContext amdarisProjectDBContext) : ControllerBase
    {
        ...
        [HttpDelete(nameof(DeleteDatabase))]
        ...
        //        Guid gameTypeId = _mediator.Send(new GetPaginatedGameTypes(pagedRequest)).Result.Items.First().Id;
        ...
        //                {
        //                    competitor.Name,
        //                    Rating = _mediator.Send(new GetCompetitorWinRatingForGameType(competitor.Id, competitionResponseDTO.GameType.Id)).Result
        //                })
        //                .ToList()
        ...
        //                await _mediator.Send(new AddValueToPointValue(match.Id, scorer ?? throw new AmdarisProjectException(""), 1));
        //            }
        //        }
