        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialStartTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ActualizedStartTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InitialStartTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ActualizedStartTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    InitialEndTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ActualizedEndTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
